...
<body>
	...
	<section class="full-box dashboard-contentPage">
        ...
        <div class="datos">
                ...
                <div><div class="text-center">{{ $respuestaU->nombres}} {{ $respuestaU->ape_paterno}} {{ $respuestaU->ape_materno}}</div></div>
			</div>
			<div class="datos1">
				<h5>Correo</h5>
				<div><div class="text-center">{{ $respuestaU->email}}</div></div>
			</div>
			<div class="datos2">
				<h5>Matricula</h5>
				<div><div class="text-center">{{ $respuestaU->matricula}}</div></div>
			</div>
			<div class="datos3">
				<h5>Carrera</h5>
				<div><div class="text-center">{{ $respuestaU->nombre_carrera}}</div></div>
			</div>
            @endif
        @empty
        @endforelse
                                                    ...
                                                    <!--con observaciones-->
                                                        <div class="col-6 p-1">
                                                            <form method="post" action="{{ route('aceptar_documento.index',[$respuestaH->id_usuario,$respuestaH->id_c_horaria,$proceso[0],1]) }}">
                                                                @csrf
                                                                <button type="submit" class="btnAceptar" > <i class="zmdi zmdi-check zmdi-hc-lg"></i> Aceptar</button>
