				...
				<ol class="list-group borde">
						...
						<div class="row lista">
							...
							<div class="col-12 col-sm-12 col-md-12 col-lg-7 p-1 colArchivo">
								@forelse ($documentos['documentos'] as $datoD)
													...
													@case(0)
														...
														<div class="row">
															<div class="col-12 col-sm-9">
																<form class="btn-cancelar-carga-horaria-system" action="{{ route('cancelar_carga_horaria_Estadia.index',[$datoCH->id_documentos,$datoCH->name]) }}" method="POST" enctype="multipart/form-data">
																	@csrf
																	<div class="row">
															...
															<div class="col-12 col-sm-3">
																<a href="{{ route('obsevaciones_carga_horaria_estadia.index') }}">
									...
									<!-- enviar carga horaria con datos-->
										@forelse ($documentos['documentos'] as $dato)														
											<form action="{{ route('actualizar_carga_horaria_estadia.index',[auth()->user()->name,$datoD->name]) }}" method="post" enctype="multipart/form-data" >
												@csrf
								...
								@empty
									...
									<form action="{{ route('subir_carga_horaria_estadia.index',[auth()->user()->name,auth()->user()->name]) }}" method="post" enctype="multipart/form-data" >
										@csrf
										<span class="btn  fileinput-button">
											<i class="zmdi zmdi-file"></i>
											<input type="file" class="archivo" name="carga_horaria">
						...
						<div class="row lista">
							...
							<div class="col-12 col-sm-12 col-md-12 col-lg-7 p-1 colArchivo">
								@forelse ($documentos['documentos'] as $datoD)
											...
											<div class="col-12 col-sm-12 py-1">
												@switch($datoCD->estado_c_d)
													@case(0)
														...
														<div class="row">
															<div class="col-12 col-sm-9">
																<form class="btn-cancelar-constancia-derecho-system" action="{{ route('cancelar_constancia_derecho_Estadia.index',[$datoCD->id_documentos,$datoCD->name]) }}" method="POST" enctype="multipart/form-data">
																	@csrf
																	<div class="row">
																		<div class="col-12 col-sm-9 id_d" >
															...
															<div class="col-12 col-sm-3">
																<a href="{{ route('obsevaciones_constancia_derecho_estadia.index') }}">
																	<button type="submit" class="btn btn-outline-danger divObservacionf02" ><i class="zmdi zmdi-folder-person">  Observaciones</i> </button>
																</a>	
															</div>
									...
									<!-- enviar carga horaria con datos-->
										@forelse ($documentos['documentos'] as $dato)														
											<form action="{{ route('actualizar_constancia_derecho_estadia.index',[auth()->user()->name,$datoD->name]) }}" method="post" enctype="multipart/form-data" >
												@csrf
								...
								@empty
									<!-- enviar carga horaria vacio-->
									<form action="{{ route('subir_constancia_derecho_estadia.index',[auth()->user()->name,auth()->user()->name]) }}" method="post" enctype="multipart/form-data" >
										@csrf
										<span class="btn  fileinput-button">
											<i class="zmdi zmdi-file"></i>
											<input type="file" class="archivo" name="constancia_derecho">
						...
						<div class="row lista">
							...
							<div class="col-12 col-sm-12 col-md-12 col-lg-7 p-1 colArchivo">
								@forelse ($documentos['documentos'] as $datoD)
											...
											<div class="col-12 col-sm-12 py-1">
												@switch($datoCR->estado_c_r)
													@case(0)
														...
														<div class="row">
															<div class="col-12 col-sm-9">
																<form class="btn-cancelar-carta-responsiva-system" action="{{ route('cancelar_carta_responsiva_Estadia.index',[$datoCR->id_documentos,$datoCR->name]) }}" method="POST" enctype="multipart/form-data">
																	@csrf
																	<div class="row">
																		<div class="col-12 col-sm-9 id_d" >
															...
															<div class="col-12 col-sm-3">
																<a href="{{ route('obsevaciones_carta_responsiva_estadia.index') }}">
																	<button type="submit" class="btn btn-outline-danger divObservacionf02" ><i class="zmdi zmdi-folder-person">  Observaciones</i> </button>
																</a>	
															</div>
									...
									<!-- enviar carga horaria con datos-->
										@forelse ($documentos['documentos'] as $dato)														
											<form action="{{ route('actualizar_carta_responsiva_estadia.index',[auth()->user()->name,$datoD->name]) }}" method="post" enctype="multipart/form-data" >
												@csrf
								...
								@empty
									<!-- enviar carga horaria vacio-->
									<form action="{{ route('subir_carta_responsiva_estadia.index',[auth()->user()->name,auth()->user()->name]) }}" method="post" enctype="multipart/form-data" >
										@csrf
										<span class="btn  fileinput-button">
											<i class="zmdi zmdi-file"></i>
											<input type="file" class="archivo" name="carta_responsiva">
							...
							<div class="col-12 col-sm-12 col-md-12 col-lg-7 p-1 colArchivo">
								@forelse ($documentos['documentos'] as $datoD)
											...
											<div class="col-12 col-sm-12 py-1">
												@switch($datoCP->estado_c_p)
													@case(0)
														...
														<div class="row">
															<div class="col-12 col-sm-9">
																<form class="btn-cancelarF1-system" action="{{ route('cancelar_f01_Estadia.index',[$datoCP->id_documentos,$datoCP->name]) }}" method="POST" enctype="multipart/form-data">
																	@csrf
																	<div class="row">
																		<div class="col-12 col-sm-9 id_d" >
															...
															<div class="col-12 col-sm-3">
																<a href="{{ route('obsevaciones_f01_estadia.index') }}">
																	<button type="submit" class="btn btn-outline-danger divObservacionf02" ><i class="zmdi zmdi-folder-person">  Observaciones</i> </button>
																</a>	
															</div>
									...
									<!-- enviar cedula registro con datos-->
										@forelse ($documentos['documentos'] as $dato)														
											<form action="{{ route('actualizar_f01_estadia.index',[auth()->user()->name,$datoD->name]) }}" method="post" enctype="multipart/form-data" >
												@csrf
								...
								@empty
									...
									<form action="{{ route('subir_f01_estadia.index',[auth()->user()->name,auth()->user()->name]) }}" method="post" enctype="multipart/form-data" >
										@csrf
										<span class="btn  fileinput-button">
											<i class="zmdi zmdi-file"></i>
											<input type="file" class="archivo" name="f01">
																...
																@switch($datoC->estado_c_r)
																	...
																	<!--aceptado-->
																		<div class="row">	
																			...
																			<div class="col-0 col-md-2 py-1 colDescargar ">
					...
					<li class="list-group-item d-flex justify-content-between align-items-start" style="border: 1px solid rgb(210, 210, 210);">
						<div class="row lista">
							<div class="col-6 col-sm-6 col-md-4 col-lg-3 col-xl-2">
								<div class="ms-2 me-auto">
									Reporte de evaluacion de estadía
								</div>
							</div>
						
								
							<div class="col-6 col-sm-12 col-md-3 col-lg-2 col-xl-2 p-1 colDescargar text-left">
								<a href="{{ route('descarga_reporte_evaluacion.index') }}">
									<button type="button" class="btn btn-outline-info btnDescargar"><i class="zmdi zmdi-download"> Descargar</i></button>
								</a>
							</div>
							<div class="col-6 col-sm-6 col-md-5 col-lg-3 col-xl-1 p-1 colLlenar  ">
