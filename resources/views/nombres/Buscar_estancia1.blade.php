            ...
            <div class="row">
                    ...
                    <form action="{{ route('Buscar_estancia1.index', [$proceso[0], $proceso[1]]) }}" method="GET">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 col-sm-4 col-md-2">
                                <button type="submit" style="background:rgb(255,103,32) " class="btn btn-primary buscar"><i
                ...
                <div class=" col-12 col-sm-12 col-md-5">
                    <form action="{{ route('Buscar_estancia1_c.index', [$proceso[0], $proceso[1]]) }}" method="GET">
                        ...
                        <div class="row">
                            <div class=" col-8 col-sm-8 col-md-10">
                                <input type="text" class="form-control" id="texto" name="texto"
                                    placeholder="Buscar datos cedula" value="">
                ...
                <div class="col-12 col-sm-6 col-md-2">
                    <a href="{{ route('documentoEstancia1Admin.index', [$proceso[0]]) }}">
                        <input type="submit" value="Ver todos" style="background: #5B3427"
                                                ...
                                                <div class="row text-center">
                                                        ...
                                                        @case(0)
                                                            <div class="col-12">
                                                                <div class="text-center p-1"><span
                                                                        class="badge bg-danger text-white">Con
                                                    ...
                                                    <div class="col-6 p-1">
                                                        <form method="post"
                                                            ...
                                                            @csrf
                                                            <button type="submit" style="background: #5B3427"S
                                                                class="btn btnVer"> <i
                                                        ...
                                                        @case(0)
                                                            ...
                                                            <div class="col-6 p-1">
                                                                <form method="post"
                                                                    ...
                                                                    @csrf
                                                                    <button type="submit" class="btn btn-success btnAceptar">
                                                            ...
                                                            <div class="col-12 p-1">
                                                                <form method="post"
                                                                    ...
                                                                    <input type="text" name="id_c" id="id_c"
                                                                        value="{{ $respuestaH->id_c_horaria }}"
                                                                        class="id_d">

                                                                    <button type="submit"
                                                                        class="btn btn-danger btnObservaciones"> <i
                                                            ...
                                                            @case(0)
                                                                ...
                                                                <div class="col-12 p-1">
                                                                    <form method="post"
                                                                        ...
                                                                        @csrf
                                                                        <input type="text" name="id_c" id="id_c"
                                                                            value="{{ $respuestaCD->id_c_derecho }}"
                                                                            class="id_d">
                                                                ...
                                                                @case(0)
                                                                    ...
                                                                    <div class="col-12 p-1">
                                                                        <form method="post"
                                                                            ...
                                                                            @csrf
                                                                            <input type="text" name="id_c" id="id_c"
                                                                                value="{{ $respuestaCR->id_c_responsiva }}"
                                                                                class="id_d">
                                                                    ...
                                                                    @case(0)
                                                                        ...
                                                                        <div class="col-12 p-1">
                                                                            <form method="post"
                                                                                ...
                                                                                @csrf
                                                                                <input type="text" name="id_c" id="id_c"
                                                                                    value="{{ $respuestaCP->id_c_presentacion }}"
                                                                                    class="id_d">
                                                                ...
                                                                <div class="row text-center">
                                                                    ...
                                                                    <div class="col-6 p-1">
                                                                        <form method="post"
                                                                            ...
                                                                            @csrf
                                                                            <button type="submit" class="btn btn-primary btnVer"> <i
                                                                                    class="zmdi zmdi-eye zmdi-hc-lg"></i> Ver</button>
                                                                        </form>
                                                                    </div>
                                                                        ...
                                                                        @case(0)
                                                                            ...
                                                                            <div class="col-12 p-1">
                                                                                <form method="post"
                                                                                    ...
                                                                                    @csrf
                                                                                    <input type="text" name="id_c" id="id_c"
                                                                                        value="{{ $respuestaC->id_c_aceptacion }}"
                                                                                        class="id_d">
                                                                            ...
                                                                            @case(0)
                                                                                ...
                                                                                <div class="col-12 p-1">
                                                                                    <form method="post"
                                                                                        ...
                                                                                        @csrf
                                                                                        <input type="text" name="id_c" id="id_c"
                                                                                            value="{{ $respuestaCR->id_c_registro }}"
                                                                                            class="id_d">
                                                                                ...
                                                                                @case(0)
                                                                                    ...
                                                                                    <div class="col-12 p-1">
                                                                                        <form method="post"
                                                                                            ...
                                                                                            @csrf
                                                                                            <input type="text" name="id_c" id="id_c"
                                                                                                value="{{ $respuestaDP->id_d_proyecto }}"
                                                                                                class="id_d">
                                                                                    ...
                                                                                    @case(0)
                                                                                        ...
                                                                                        <div class="col-12 p-1">
                                                                                            <form method="post"
                                                                                                ...
                                                                                                @csrf
                                                                                                <input type="text" name="id_c" id="id_c"
                                                                                                    value="{{ $respuestaCL->id_c_liberacion }}"
                                                                                                    class="id_d">
                                                                                            ...
                                                                                            @case(0)
                                                                                                ...
                                                                                                <div class="col-6 p-1">
                                                                                                    <form method="post"
                                                                                                        ...
                                                                                                        @csrf
                                                                                                        <button type="submit"
                                                                                                            class="btn btn-success btnAceptar"> <i
                                                                                                                class="zmdi zmdi-check zmdi-hc-lg"></i>
                                                                                                            Aceptar</button>
                                                                                                        <input type="hidden" class="form-control"
                                                                                                            name="texto1" value="{{ $texto }}">
                                                                                                    </form>
                                                                                                </div>
                                                                                                <div class="col-12 p-1">
                                                                                                    <form method="post"
                                                                                                ...
                                                                                                <div class="col-12 p-1">
                                                                                                    <form method="post"
                                                                                                        ...
                                                                                                        @csrf
                                                                                                        <input type="text" name="id_c" id="id_c"
                                                                                                            value="{{ $respuestaA->id_c_compromiso }}"
                                                                                                            class="id_d">
                                                                                                ...
                                                                                                @case(0)
                                                                                                    ...
                                                                                                    <div class="col-12 p-1">
                                                                                                        <form method="post"
                                                                                                            ...
                                                                                                            @csrf
                                                                                                            <input type="text" name="id_c" id="id_c"
                                                                                                                value="{{ $respuestarm->id_r_mensual }}"
                                                                                                                class="id_d">
                                                                                                    ...
                                                                                                    @case(0)
                                                                                                        ...
                                                                                                        <div class="col-12 p-1">
                                                                                                            <form method="post"
                                                                                                                ...
                                                                                                                @csrf
                                                                                                                <input type="text" name="id_c"
                                                                                                                    id="id_c"
                                                                                                                    value="{{ $respuestarm->id_r_mensual2 }}"
                                                                                                                    class="id_d">
                                                                                                        ...
                                                                                                        <div class="col-6 p-1">
                                                                                                            <form method="post"
                                                                                                                ...
                                                                                                                <button type="submit"
                                                                                                                    class="btn btn-success btnAceptar"> <i
                                                                                                                        class="zmdi zmdi-check zmdi-hc-lg"></i>
                                                                                                                    Aceptar {{ $respuestarm->id_r_mensual2 }}
                                                                                                                </button>
                                                                                                                <input type="hidden" class="form-control"
                                                                                                                    name="texto1" value="">
                                                                                                            </form>
                                                                                                        ...
                                                                                                        @case(0)
                                                                                                            ...
                                                                                                            <div class="col-12 p-1">
                                                                                                                <form method="post"
                                                                                                                    ...
                                                                                                                    <input type="text" name="id_c"
                                                                                                                        id="id_c"
                                                                                                                        value="{{ $respuestarm->id_r_mensual3 }}"
                                                                                                                        class="id_d">
                                                                                                            ...
                                                                                                            <div class="col-6 p-1">
                                                                                                                <form method="post"
                                                                                                                    ...
                                                                                                                    <button type="submit"
                                                                                                                        class="btn btn-success btnAceptar"> <i
                                                                                                                            class="zmdi zmdi-check zmdi-hc-lg"></i>
                                                                                                                        Aceptar {{ $respuestarm->id_r_mensual3 }}
                                                                                                                    </button>
                                                                                                                    <input type="hidden" class="form-control"
                                                                                                                        name="texto1" value="">
                                                                                                                </form>
                                                                                                            ...
                                                                                                            @case(0)
                                                                                                                ...
                                                                                                                <div class="col-12 p-1">
                                                                                                                    <form method="post"
                                                                                                                        ...
                                                                                                                        <input type="text" name="id_c"
                                                                                                                            id="id_c"
                                                                                                                            value="{{ $respuestarm->id_r_mensual4 }}"
                                                                                                                            class="id_d">
                                                                                                                ...
                                                                                                                <div class="col-6 p-1">
                                                                                                                    <form method="post"
                                                                                                                        ...
                                                                                                                        <button type="submit"
                                                                                                                            class="btn btn-success btnAceptar"> <i
                                                                                                                                class="zmdi zmdi-check zmdi-hc-lg"></i>
                                                                                                                            Aceptar {{ $respuestarm->id_r_mensual4 }}
                                                                                                                        </button>
                                                                                                                        <input type="hidden" class="form-control"
                                                                                                                            name="texto1" value="">
                                                                                                                    </form>
                                                                                                                ...
                                                                                                                @case(0)
                                                                                                                    ...
                                                                                                                    <div class="col-12 p-1">
                                                                                                                        <form method="post"
                                                                                                                            ...
                                                                                                                            <input type="text" name="id_c"
                                                                                                                                id="id_c"
                                                                                                                                value="{{ $respuestarm->id_r_mensual5 }}"
                                                                                                                                class="id_d">
                                                                                                                    ...
                                                                                                                    <div class="col-6 p-1">
                                                                                                                        <form method="post"
                                                                                                                            ...
                                                                                                                            <button type="submit"
                                                                                                                                class="btn btn-success btnAceptar"> <i
                                                                                                                                    class="zmdi zmdi-check zmdi-hc-lg"></i>
                                                                                                                                Aceptar {{ $respuestarm->id_r_mensual5 }}
                                                                                                                            </button>
                                                                                                                            <input type="hidden" class="form-control"
                                                                                                                                name="texto1" value="">
                                                                                                                        </form>
                                                                                                                    ...
                                                                                                                    @case(0)
                                                                                                                        ...
                                                                                                                        <div class="col-12 p-1">
                                                                                                                            <form method="post"
                                                                                                                                ...
                                                                                                                                <input type="text" name="id_c"
                                                                                                                                    id="id_c"
                                                                                                                                    value="{{ $respuestarm->id_r_mensual6 }}"
                                                                                                                                    class="id_d">
                                                                                                                        ...
                                                                                                                        <div class="col-6 p-1">
                                                                                                                            <form method="post"
                                                                                                                                ...
                                                                                                                                <button type="submit"
                                                                                                                                    class="btn btn-success btnAceptar"> <i
                                                                                                                                        class="zmdi zmdi-check zmdi-hc-lg"></i>
                                                                                                                                    Aceptar {{ $respuestarm->id_r_mensual6 }}
                                                                                                                                </button>
                                                                                                                                <input type="hidden" class="form-control"
                                                                                                                                    name="texto1" value="">
                                                                                                                            </form>
                                                                                                                        ...
                                                                                                                        @case(0)
                                                                                                                            ...
                                                                                                                            <div class="col-12 p-1">
                                                                                                                                <form method="post"
                                                                                                                                    ...
                                                                                                                                    <input type="text" name="id_c"
                                                                                                                                        id="id_c"
                                                                                                                                        value="{{ $respuestarm->id_r_mensual7 }}"
                                                                                                                                        class="id_d">
                                                                                                                            ...
                                                                                                                            <div class="col-6 p-1">
                                                                                                                                <form method="post"
                                                                                                                                    ...
                                                                                                                                    <button type="submit"
                                                                                                                                        class="btn btn-success btnAceptar"> <i
                                                                                                                                            class="zmdi zmdi-check zmdi-hc-lg"></i>
                                                                                                                                        Aceptar {{ $respuestarm->id_r_mensual7 }}
                                                                                                                                    </button>
                                                                                                                                    <input type="hidden" class="form-control"
                                                                                                                                        name="texto1" value="">
                                                                                                                                </form>
                                                                                                                            ...
                                                                                                                            @case(0)
                                                                                                                                ...
                                                                                                                                <div class="col-12 p-1">
                                                                                                                                    <form method="post"
                                                                                                                                        ...
                                                                                                                                        <input type="text" name="id_c"
                                                                                                                                            id="id_c"
                                                                                                                                            value="{{ $respuestarm->id_r_mensual8 }}"
                                                                                                                                            class="id_d">
                                                                                                                                ...
                                                                                                                                <div class="col-6 p-1">
                                                                                                                                    <form method="post"
                                                                                                                                        ...
                                                                                                                                        <button type="submit"
                                                                                                                                            class="btn btn-success btnAceptar"> <i
                                                                                                                                                class="zmdi zmdi-check zmdi-hc-lg"></i>
                                                                                                                                            Aceptar {{ $respuestarm->id_r_mensual8 }}
                                                                                                                                        </button>
                                                                                                                                        <input type="hidden" class="form-control"
                                                                                                                                            name="texto1" value="">
                                                                                                                                    </form>
                                                                                                                                ...
                                                                                                                                @case(0)
                                                                                                                                    ...
                                                                                                                                    <div class="col-12 p-1">
                                                                                                                                        <form method="post"
                                                                                                                                            ...
                                                                                                                                            <input type="text" name="id_c"
                                                                                                                                                id="id_c"
                                                                                                                                                value="{{ $respuestarm->id_r_mensual9 }}"
                                                                                                                                                class="id_d">
                                                                                                                                    ...
                                                                                                                                    <div class="col-6 p-1">
                                                                                                                                        <form method="post"
                                                                                                                                            ...
                                                                                                                                            <button type="submit"
                                                                                                                                                class="btn btn-success btnAceptar"> <i
                                                                                                                                                    class="zmdi zmdi-check zmdi-hc-lg"></i>
                                                                                                                                                Aceptar {{ $respuestarm->id_r_mensual9 }}
                                                                                                                                            </button>
                                                                                                                                            <input type="hidden" class="form-control"
                                                                                                                                                name="texto1" value="">
                                                                                                                                        </form>
                                                                                                                                    ...
                                                                                                                                    @case(0)
                                                                                                                                        ...
                                                                                                                                        <div class="col-12 p-1">
                                                                                                                                            <form method="post"
                                                                                                                                                ...
                                                                                                                                                <input type="text" name="id_c"
                                                                                                                                                    id="id_c"
                                                                                                                                                    value="{{ $respuestarm->id_r_mensual10 }}"
                                                                                                                                                    class="id_d">
                                                                                                                                        ...
                                                                                                                                        <div class="col-6 p-1">
                                                                                                                                            <form method="post"
                                                                                                                                                ...
                                                                                                                                                <button type="submit"
                                                                                                                                                    class="btn btn-success btnAceptar"> <i
                                                                                                                                                        class="zmdi zmdi-check zmdi-hc-lg"></i>
                                                                                                                                                    Aceptar {{ $respuestarm->id_r_mensual10 }}
                                                                                                                                                </button>
                                                                                                                                                <input type="hidden" class="form-control"
                                                                                                                                                    name="texto1" value="">
                                                                                                                                            </form>
                                                                                                                                        ...
                                                                                                                                        @case(0)
                                                                                                                                            ...
                                                                                                                                            <div class="col-12 p-1">
                                                                                                                                                <form method="post"
                                                                                                                                                    ...
                                                                                                                                                    <input type="text" name="id_c"
                                                                                                                                                        id="id_c"
                                                                                                                                                        value="{{ $respuestarm->id_r_mensual11 }}"
                                                                                                                                                        class="id_d">
                                                                                                                                            ...
                                                                                                                                            <div class="col-6 p-1">
                                                                                                                                                <form method="post"
                                                                                                                                                    ...
                                                                                                                                                    <button type="submit"
                                                                                                                                                        class="btn btn-success btnAceptar"> <i
                                                                                                                                                            class="zmdi zmdi-check zmdi-hc-lg"></i>
                                                                                                                                                        Aceptar {{ $respuestarm->id_r_mensual11 }}
                                                                                                                                                    </button>
                                                                                                                                                    <input type="hidden" class="form-control"
                                                                                                                                                        name="texto1" value="">
                                                                                                                                                </form>
                                                                                                                                            ...
                                                                                                                                            @case(0)
                                                                                                                                                ...
                                                                                                                                                <div class="col-12 p-1">
                                                                                                                                                    <form method="post"
                                                                                                                                                        ...
                                                                                                                                                        <input type="text" name="id_c"
                                                                                                                                                            id="id_c"
                                                                                                                                                            value="{{ $respuestarm->id_r_mensual12 }}"
                                                                                                                                                            class="id_d">
                                                                                                                                                ...
                                                                                                                                                <div class="col-6 p-1">
                                                                                                                                                    <form method="post"
                                                                                                                                                        ...
                                                                                                                                                        <button type="submit"
                                                                                                                                                            class="btn btn-success btnAceptar"> <i
                                                                                                                                                                class="zmdi zmdi-check zmdi-hc-lg"></i>
                                                                                                                                                            Aceptar {{ $respuestarm->id_r_mensual12 }}
                                                                                                                                                        </button>
                                                                                                                                                        <input type="hidden" class="form-control"
                                                                                                                                                            name="texto1" value="">
                                                                                                                                                    </form>
